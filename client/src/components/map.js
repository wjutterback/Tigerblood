...
function Map() {
  ...
  return (
    <>
      <div className="row">
        <div className="col">
          <div id="map" style={{height:"1070px", width: "1060px", overflow: "auto"}}>
            {/* MAP goes here */}
          </div>
        </div>
        <div className="col">
          <div className="row" style={{height: "600px", padding: "15px"}}>
            <div className="col-sm-12" style={{ fontSize: "30px", fontFamily: "cursive", color: "orange", border: "2px dashed brown", background: "black", padding: "50px" }}>
              {message}
            </div>
          </div>
